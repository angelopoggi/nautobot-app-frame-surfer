...
- `project_name`: the default docker compose project name (default: `frame-surfer`)
...
Using **Invoke** these configuration options can be overridden using [several methods](https://docs.pyinvoke.org/en/stable/concepts/configuration.html). Perhaps the simplest is setting an environment variable `INVOKE_FRAME_SURFER_VARIABLE_NAME` where `VARIABLE_NAME` is the variable you are trying to override. The only exception is `compose_files`, because it is a list it must be overridden in a YAML file. There is an example `invoke.yml` (`invoke.example.yml`) in this directory which can be used as a starting point.
...
#14 naming to docker.io/frame-surfer/nautobot:2.0.0-py3.11 done
```
...
Creating network "frame_surfer_default" with the default driver
Creating volume "frame_surfer_postgres_data" with default driver
Creating frame_surfer_redis_1 ...
Creating frame_surfer_docs_1  ...
Creating frame_surfer_postgres_1 ...
Creating frame_surfer_postgres_1 ... done
Creating frame_surfer_redis_1    ... done
Creating frame_surfer_nautobot_1 ...
Creating frame_surfer_docs_1     ... done
Creating frame_surfer_nautobot_1 ... done
Creating frame_surfer_worker_1   ...
Creating frame_surfer_worker_1   ... done
...
ee90fbfabd77   frame-surfer/nautobot:2.0.0-py3.11  "nautobot-server rqw…"   16 seconds ago   Up 13 seconds                                               frame_surfer_worker_1
b8adb781d013   frame-surfer/nautobot:2.0.0-py3.11  "/docker-entrypoint.…"   20 seconds ago   Up 15 seconds   0.0.0.0:8080->8080/tcp, :::8080->8080/tcp   frame_surfer_nautobot_1
d64ebd60675d   frame-surfer/nautobot:2.0.0-py3.11  "mkdocs serve -v -a …"   25 seconds ago   Up 18 seconds   0.0.0.0:8001->8080/tcp, :::8001->8080/tcp   frame_surfer_docs_1
e72d63129b36   postgres:13-alpine               "docker-entrypoint.s…"   25 seconds ago   Up 19 seconds   0.0.0.0:5432->5432/tcp, :::5432->5432/tcp   frame_surfer_postgres_1
96c6ff66997c   redis:6-alpine                   "docker-entrypoint.s…"   25 seconds ago   Up 21 seconds   0.0.0.0:6379->6379/tcp, :::6379->6379/tcp   frame_surfer_redis_1
```
...
Stopping frame_surfer_worker_1   ...
Stopping frame_surfer_nautobot_1 ...
Stopping frame_surfer_docs_1     ...
Stopping frame_surfer_redis_1    ...
Stopping frame_surfer_postgres_1 ...
Stopping frame_surfer_worker_1   ... done
Stopping frame_surfer_nautobot_1 ... done
Stopping frame_surfer_postgres_1 ... done
Stopping frame_surfer_redis_1    ... done
Stopping frame_surfer_docs_1     ... done
Removing frame_surfer_worker_1   ...
Removing frame_surfer_nautobot_1 ...
Removing frame_surfer_docs_1     ...
Removing frame_surfer_redis_1    ...
Removing frame_surfer_postgres_1 ...
Removing frame_surfer_postgres_1 ... done
Removing frame_surfer_docs_1     ... done
Removing frame_surfer_worker_1   ... done
Removing frame_surfer_redis_1    ... done
Removing frame_surfer_nautobot_1 ... done
Removing network frame_surfer_default
```
...
So for example, our app is named `frame-surfer`, the command would most likely be `docker logs frame_surfer_nautobot_1 -f`. You can find the name of all running containers via `docker ps`.
...
```python
namespace = Collection("frame_surfer")
namespace.configure(
    {
        "frame_surfer": {
            ...
...
Or set the `INVOKE_FRAME_SURFER_PYTHON_VER` variable.
...
Or set the `INVOKE_FRAME_SURFER_NAUTOBOT_VER` variable.
...
In the package source, there is the `frame_surfer/app-config-schema.json` file, conforming to the [JSON Schema](https://json-schema.org/) format. This file is used to validate the configuration of the app in CI pipelines.
